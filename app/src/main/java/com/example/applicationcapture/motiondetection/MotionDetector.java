package com.example.applicationcapture.motiondetection;
...
public class MotionDetector {
    public static int[] changedImageArray;
                    ...
                    if (nextData.get() != null) {
                       // int[] img = ImageProcessing.decodeYUV420SPtoLuma(nextData.get(), nextWidth.get(), nextHeight.get());
                        ...
                        if (lumaSum < minLuma) {
                            ...
                            // check
                            changedImageArray=img;
                            img_width=nextWidth.get();
                            img_height=nextHeight.get();
    ...
    private long checkInterval = 2500;//required time between two photos
